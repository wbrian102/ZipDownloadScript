...
# Define paths
SOURCE_DIR = Path("C:/Users/name/Downloads") #Folder where ZIP files are downloaded
TARGET_DIR = Path("C:/Users/name/Folder") #Folder where unzipped files will be installed
TEMP_DIR = Path ("C:/Users/name/Documents/TEMPZipFiles") #Temporary area to unzip files to avoid collision
